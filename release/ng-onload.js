...
angular.module("ngOnload", []).directive(elementOnloadDirective.directiveName, elementOnloadDirective).directive(elementDirective.directiveName, elementDirective);